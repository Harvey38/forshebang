const Card = require("./../models/cardreview");
const Review = require("./../models/review");
const fs = require("fs");
var revdesc = "";
var revcard = "";
var overall = "";
const m = fs.readFileSync("template_desc.html");
revdesc = revdesc + m;
const n = fs.readFileSync("template_reviewcard.html");
revcard = revcard + n;
const o = fs.readFileSync("template_overview.html");
overall = overall + o;
